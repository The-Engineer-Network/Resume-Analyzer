    ...
    <div className=" bg-white/80 z-10 border-b-gray-100 border-b shadow-sm backdrop-blur-sm">
      ...
      <div className="flex items-center gap-x-4">
        ...
        <div className="flex items-center gap-x-8">
          ...
          <a href="#" className="hover:text-blue-700 font-bold text-gray-600">Dashboard</a>
          <a  href="#" className="hover:text-blue-700 font-bold text-gray-600" >History</a>
          <a  href="#" className="hover:text-blue-700 font-bold text-gray-600">Settings</a>
          </div>
